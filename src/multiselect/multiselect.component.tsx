...
export class Multiselect extends React.Component<IMultiselectProps, any> {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      groupSelectAll: false, // Add a new state property
    };
    // @ts-ignore
  ...
  groupSelectAll(group: any[]) {
    // Implement the logic to select all options in the group
    const { selectedValues, options } = this.state;
    const { onSelect, onRemove } = this.props;

    const unselectedOptions = group.filter(
      (option) => !this.isSelectedValue(option)
    );

    const updatedSelectedValues = [...selectedValues, ...unselectedOptions];
    this.setState({ selectedValues: updatedSelectedValues }, () => {
      onSelect(updatedSelectedValues, unselectedOptions);
    });
  }
  //-----------------------------------------------------------------------------------------------------------------------
...
Multiselect.defaultProps = {
  ...
  groupSelectAll: false, // Add a default prop for groupSelectAll
